...
import { initializeFirebase, getCurrentUser as firebaseGetCurrentUser } from './firebase';
...
if (typeof window !== 'undefined') {
    ...
    if (auth) {
        ...
        getCurrentUser().then(user => {
            ...
            console.error('Initial user retrieval error:', {
...
export async function getAuthenticatedUser(): Promise<User | null> {
    ...
    console.log('Get Authenticated User Debug:', {
